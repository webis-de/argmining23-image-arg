...
def summarize_text(input_text):
    ...
    generated_output = model.generate(input_ids, attention_mask=attention_mask, pad_token_id=model.config.eos_token_id, num_return_sequences=1, max_new_tokens=10)
