    ...
    for epoch in range(num_epochs):
        ...
        for i in range(len(train_dataset)):
            ...
            with torch.no_grad():
                ...
                infographic_feature = check_infographic(image)
...
if __name__ == "__main__":
    ...
    infographic_feature_size = 1

    custom_model = CustomModel(num_classes, clip_feature_size, infographic_feature_size)
